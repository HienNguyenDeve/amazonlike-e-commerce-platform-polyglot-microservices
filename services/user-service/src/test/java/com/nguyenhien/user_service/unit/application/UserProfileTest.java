...
public class UserProfileTest {
    ...
    void shouldCreateProfileSuccessfully() {
        ...
        assertThat(profile.getAuthUserId())
        ...
        assertThat(profile.isProfileCompleted())
                .isFalse();

        assertThat(profile.getLoyaltyPoint())
                .isZero();

        assertThat(profile.getAddresses())
                .isEmpty();

        assertThat(profile.getPreference())
                .isNull();
    }
    ...
    void shouldUpdateProfileSuccessfully() {
        ...
        assertThat(profile.getGender())
                .isEqualTo(Gender.MALE);

        assertThat(profile.getBirthday())
                .isEqualTo(birthday);
